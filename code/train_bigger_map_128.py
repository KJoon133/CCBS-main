...
from core.model.models import cnn_mlp_BN, cnn_mlp_BN_Dropout, cnn_mlp_Dropout, cnn_mlp_BN_Dropout_1, cnn_mlp_BN_Dropout_2, cnn_mlp_BN_Dropout_3, cnn_mlp_large
from core.model.Unet import UNet_2D_128
...
def main():
    ...
    train_scene_list = get_scene_80("test_69", "bigger_heatmap", dataset="train")
    valid_scene_list = get_scene_80("test_69", "bigger_heatmap", dataset="valid")
    ...
    if args.model == None:
        ...
        if args.model == "unet_128":
            model = UNet_2D_128(2, 1, 102).to(device)
            model_name = "unet_128"
