...
class EPEA_Star(object):
    ...
    def select_operator(self, node, children_with_F=None):
        ''' the Operator Selection Function - OSF for EPEA*'''
    ...
    def find_paths(self):
        ...
        while len(self.open_list) > 0:
            ...
            children, next_F = self.select_operator(curr)
