...
import heapq
import random
from core.func.single_agent_planner import  a_star, compute_heuristics, get_location, get_sum_of_cost
import math
import copy
import numpy
from core.func.vertex_cover import Find_h4
        ...
        while len(self.open_list) > 0:
            ...
            for collision in p['collisions']:
                ...
                if collision_type == 'cardinal' and new_constraints is None:    
                    ...
                    E = generated_collisiin_graph(p['paths'])
                    h = vertex_cover(E)
