...
class Animation:
    ...
    def save(self, file_name):
        # save(self, filename, writer=None, fps=None, dpi=None, codec=None,
        #      bitrate=None, extra_args=None, metadata=None, extra_anim=None,
        #      savefig_kwargs=None, *, progress_callback=None)
        video_writer = animation.PillowWriter(fps=30)
        self.animation.save(filename=file_name, writer=video_writer)
